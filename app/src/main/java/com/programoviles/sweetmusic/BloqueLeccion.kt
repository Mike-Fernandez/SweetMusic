...
//                dataSet = arrayListOf<Any>("*" + arguments?.getString("lesson")!!, resources.getString(R.string.L1T1), resources.getString(R.string.L1T2), R.drawable.imagen1)
            ...
            "Lección: 13 Signos de repetición, dinámicas y artículaciones" -> {
                dataSet2 = arrayListOf<Any>("*" + arguments?.getString("lesson")!!, resources.getString(R.string.L13T1), resources.getString(R.string.L13T2), R.drawable.imagen29, resources.getString(R.string.L13T3), R.drawable.imagen30, resources.getString(R.string.L13T4), R.drawable.imagen31, resources.getString(R.string.L13T5), resources.getString(R.string.L13T6), resources.getString(R.string.L13T7), R.drawable.dinamica, resources.getString(R.string.L13T8), resources.getString(R.string.L13T9), R.drawable.arti)
            }
            "Lección: 14 Introducción a las escalas" -> {
                dataSet2 = arrayListOf<Any>("*" + arguments?.getString("lesson")!!, resources.getString(R.string.L14T1), resources.getString(R.string.L14T2), R.drawable.grados, resources.getString(R.string.L14T3), resources.getString(R.string.L14T4))
            }
            "Lección: 15 Escala Mayor Natural" -> {
                dataSet2 = arrayListOf<Any>("*" + arguments?.getString("lesson")!!, resources.getString(R.string.L15T1), resources.getString(R.string.L15T2), resources.getString(R.string.L15T3), resources.getString(R.string.L15T4), R.drawable.imagen32, resources.getString(R.string.L15T5), R.drawable.imagen33)
            }
            "Lección: 16 Escala Menor Natural" -> {
                dataSet2 = arrayListOf<Any>("*" + arguments?.getString("lesson")!!, resources.getString(R.string.L16T1), resources.getString(R.string.L16T2), resources.getString(R.string.L16T3), resources.getString(R.string.L16T4), R.drawable.imagen34)
            }
            "Lección: 17 Tonalidades" -> {
                dataSet2 = arrayListOf<Any>("*" + arguments?.getString("lesson")!!, resources.getString(R.string.L17T1), resources.getString(R.string.L17T2), R.drawable.imagen35, resources.getString(R.string.L17T3), resources.getString(R.string.L17T4), resources.getString(R.string.L17T5), R.drawable.imagen36, resources.getString(R.string.L17T6), R.drawable.imagen37, resources.getString(R.string.L17T7), resources.getString(R.string.L17T8))
            }
            "Lección: 18 Escala Pentatónica y armónica" -> {
                dataSet2 = arrayListOf<Any>("*" + arguments?.getString("lesson")!!, resources.getString(R.string.L18T1), resources.getString(R.string.L18T2), resources.getString(R.string.L18T3), resources.getString(R.string.L18T4), R.drawable.imagen38, resources.getString(R.string.L18T5), resources.getString(R.string.L18T6), resources.getString(R.string.L18T7), R.drawable.imagen39, resources.getString(R.string.L18T8), resources.getString(R.string.L18T9), R.drawable.imagen40)
            }
            "Lección: 19 Escala menor bachiana, menor melódica y cromática" -> {
                dataSet2 = arrayListOf<Any>("*" + arguments?.getString("lesson")!!, resources.getString(R.string.L19T1), resources.getString(R.string.L19T2), R.drawable.imagen41, resources.getString(R.string.L19T3), resources.getString(R.string.L19T4), R.drawable.imagen42, resources.getString(R.string.L19T5), resources.getString(R.string.L19T6), R.drawable.imagen43, resources.getString(R.string.L19T7))
            }
            "Lección: 20 Intervalos" -> {
                dataSet2 = arrayListOf<Any>("*" + arguments?.getString("lesson")!!, resources.getString(R.string.L20T1), resources.getString(R.string.L20T2), R.drawable.imagen44, resources.getString(R.string.L20T3), resources.getString(R.string.L20T4), resources.getString(R.string.L20T5), R.drawable.imagen45, resources.getString(R.string.L20T6), resources.getString(R.string.L20T7), R.drawable.imagen46, resources.getString(R.string.L20T8), resources.getString(R.string.L20T9), R.drawable.imagen47, resources.getString(R.string.L20T10), resources.getString(R.string.L20T11), R.drawable.imagen48, resources.getString(R.string.L20T12), resources.getString(R.string.L20T13), R.drawable.imagen49, resources.getString(R.string.L20T14), resources.getString(R.string.L20T15), R.drawable.imagen50, resources.getString(R.string.L20T16), resources.getString(R.string.L20T17), R.drawable.imagen51, resources.getString(R.string.L20T18), resources.getString(R.string.L20T19), R.drawable.imagen52, resources.getString(R.string.L20T20), resources.getString(R.string.L20T21), R.drawable.imagen53 )
            }
